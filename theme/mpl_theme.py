...
``apply_adaptyv_blog_post_theme(fig, ax, ...)``
...
Used throughout the repo as::
    ...
    from theme.mpl_theme import set_adaptyv_style, ADAPTYV_COLORS
...
ADAPTYV_COLORS: Dict[str, str] = _build_flat_colors()
"""Flat dict of every named Adaptyv color (cyan/ink/good/binder/etc.)."""
...
def set_adaptyv_style(*, dark: bool = False) -> None:
    ...
    mpl.rcParams.update({
        ...
        # Grid (off in canonical Adaptyv style — let the data carry the surface)
        "axes.grid": False,
        # Spines
...
__all__ = [
    "ADAPTYV_COLORS",
    "set_adaptyv_style",
    "set_adaptyv_matplotlib_theme",  # legacy alias
